...
class BetterHudOptionEntry(
    ...
    val popupId: Var<String> = ConstVar("typewriter_dialogue_option"),
    ...
    @Help("Disable infinite scrolling through options")
    val disableInfiniteScroll: Var<Boolean> = ConstVar(false),
...
data class Option(
    @Help("The text to display for this option")
    @Placeholder
    val text: Var<String> = ConstVar(""),

    @Help("Criteria that must be met for this option to be shown")
    val criteria: List<Criteria> = emptyList(),

    @Help("Modifiers to apply when this option is selected")
    val modifiers: List<Modifier> = emptyList(),

    @Help("Triggers to fire when this option is selected")
